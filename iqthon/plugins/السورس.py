...
IQTHONPC = gvarstatus("ALIVE_PIC") or "https://telegra.ph/file/88b0307eda38438f2eae4.jpg"
...
IQPIC = gvarstatus("ALIVE_PIC") or "https://telegra.ph/file/88b0307eda38438f2eae4.jpg"
...
async def iq(iqthonevent):
    ...
    ALIVE_TEXT = gvarstatus("ALIVE_TEXT") or "𝗐𝖾𝗅𝖼𝗈𝗆𝖾 Rsthon 𓃠"
    IQTHON_IMG = gvarstatus("ALIVE_PIC") or "https://telegra.ph/file/88b0307eda38438f2eae4.jpg"
...
async def _(event):
    ...
    OUTPUT = (f"♛︙  وحـدة المعلومات الخاصه بتنصيبك مع جميع الفارات  لتنصيب سورس رسثون @RS_SY :**\n\n{o}")
...
async def _(event):
    ...
    await asyncio.sleep(1)
    await edit_or_reply(event , "حسنا جاري تحديث رسثون  انتضر من 5 الى 10 دقائق")
    try:
...
https://t.me/RS_HB1/4718
• لكيفيه حذف الفار اضغط هنا ↶
https://t.me/RS_SI/51

قناة الكلايش  : @RS_A0
قناه شروحات الاوامر  : @RS_HB1
قناه المتغيرات او الفارات : @RS_SI""")
    ...
    if vname in vlist:
        ...
        if cmd == "اضف":
            if not vinfo and vname == "ALIVE_TEMPLATE":
                return await edit_delete(event, f"**♛︙  📑 يرجى متابع قناه الفارات تجدها هنا : @RS_SY")
...
( .ايقاف اسم وقتي )
———————×———————
 ♛︙ يوجد شرح مفصل عن الامر هنا : https://t.me/RS_HB1/4484
""")
...
الشرح :   يضيفلك جميع الاعضاء الي برابط الكروب يضيفهم بكروبك 
 ———————×———————
يوجد شرح بتفصيل هنا : https://t.me/RS_HB1/4483
شرح الأوامر : ( @RS_HB1 ) .
قناه السورس : ( @RS_SY ) .
جميع الاوامر تكون بدايتها نقطة .
""")
...
———————×———————
يوجد شرح مفصل للتكرار هنا : https://t.me/RS_HB1/4704 
قناه السورس : ( @RS_SY ) .
جميع الاوامر تكون بدايتها نقطة .
""")
...
✐ :  يعطيك رموز للزخرفه2 
———————×———————
يوجد شرح مفصل عن اوامر زخرفه هنا : https://t.me/RS_HB1/4705
""")
...
———————×———————
  ⦑   شرح اوامر الوسائط هنا :  https://t.me/RS_HB1/4721  ⦒
""")
...
———————×———————
  ⦑   شرح اوامر الملصقات هنا  :  https://t.me/RS_HB1/4720  ⦒
""")
...
———————×——————— 
الأمر ⦙ ( .المده )
الشرح  : يضهر لك مدة تشغيل بوت رسثون لديك 
———————×———————
الأمر ⦙ ( .تحميل ملف + الرد ع الملف )
الشرح : يحمل ملفات رسثون 
———————×———————
الأمر ⦙ ( .مسح ملف + الرد ع الملف )
الشرح :  يمسح الملف الي حملته  
———————×———————
الأمر ⦙ ( .تحديث )
الشرح :  امر لأعاده التشغيل وتحديث ملفات السورس وتسريع الرسثون 
———————×———————
الأمر ⦙ ( .اطفاء مؤقت + عدد الثواني )
الشرح : يقوم بأطفاء الرسثون بعدد الثواني الي ضفتها  عندما تخلص الثواني سيتم اعاده تشغيل الرسثون 
———————×———————
الأمر ⦙ ( .الاوامر ) 
...
———————×———————
الأمر ⦙ ( .استخدامي )
الشرح :   يضهر لك كمية استخدامك لرسثون
———————×———————
الأمر ⦙ ( .تاريخ التنصيب )
...
الشرح : اي شخص يعملك تاك او يراسلك او يرد عليك يرد عليه رسثون بكليشة انا حاليا غير موجود ويضع له السبب الي نتة وضعته
———×———
...
الأمر  :  يقوم بترجمه الرساله الى اللغه يه 
———————×——————
شرح الأوامر : ( @RS_HB1 ) .
قناه السورس : ( @RS_SY ) .
جميع الاوامر تكون بدايتها نقطة .""")
